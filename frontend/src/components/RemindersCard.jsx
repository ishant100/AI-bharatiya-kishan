...
export function RemindersCard({ storageKey = "agri.reminders", defaultTitleHint = "e.g., Irrigate paddy field" }) {
  const [items, setItems, reset] = useLocalStorage(storageKey, []);
  ...
  return (
    <Card className="p-6 shadow-md border border-emerald-200 bg-white/80 backdrop-blur-md animate-fade-in-up">
      ...
      <div className="grid md:grid-cols-5 gap-2 mb-4">
        ...
        <Select value={repeat} onValueChange={(v) => setRepeat(v)}>
