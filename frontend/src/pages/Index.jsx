...
import { fetchMarketPrices } from "@/services/markets";
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        const t0 = d.hourly?.soil_temperature_0cm ?? [];
        const m0 = d.hourly?.soil_moisture_0_to_7cm ?? [];
        const out = [];
